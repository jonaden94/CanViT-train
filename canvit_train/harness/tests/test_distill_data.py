...
from canvit_train.distill.data.webdataset import WebDatasetTrainLoader
...
def test_checkpoint_model_config_wins_over_cli_defaults():
    ...
    with patch("canvit_train.distill.model.load_student_backbone", side_effect=RuntimeError("stop")):
        try:
