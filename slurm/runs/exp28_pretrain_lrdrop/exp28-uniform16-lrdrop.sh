#!/bin/bash
# exp28 PHASE B — the x0.1 LR drop for exp28-uniform16.
#
# DO NOT SUBMIT until exp28-uniform16 has actually produced step-1441792.pt. Phase A's
...
#     optimizer/scheduler/step=0; NEW wandb run (parent untouched). Parent step k <-> k-1441792.
...
RUN_NAME=exp28-uniform16-lrdrop
...
SEED_CKPT=/mnt/vast-nhr/projects/nib00021/jonathan/repos/canvit/logs/exp28_pretrain_lrdrop/exp28-uniform16/checkpoints/step-1441792.pt
if [ ! -f "$SEED_CKPT" ]; then
    echo "REFUSING: $SEED_CKPT does not exist yet."
    echo "Phase A (exp28-uniform16) has not reached step 1441792."
