#!/bin/bash
# exp32 PHASE B — the x0.1 LR drop for exp32-fovi-teacherinit.
#
# DO NOT SUBMIT until exp32-fovi-teacherinit has actually produced step-1130496.pt. Phase A's
...
RUN_NAME=exp32-fovi-teacherinit-lrdrop
