...
`claude_dev/unification/`, so `canvit_train/` at HEAD is identical to the commit these runs were
...
It is complementary to `claude_dev/unification/throughput_ab.py`, which measures training
