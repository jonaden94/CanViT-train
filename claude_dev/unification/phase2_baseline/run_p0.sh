#!/bin/bash
# P1 numeric baseline (doc 21 P0) — the four harness.evaluate rows that P3 must reproduce
# bit-identically after the core merge. Same four rows as
# claude_dev/unification/stage0_baseline/gate3b.sh, re-recorded because F1 makes them
