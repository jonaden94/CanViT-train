"""Tests for canvit.distill.viz module."""

import numpy as np
import torch

from canvit.distill.viz.image import imagenet_denormalize_to_numpy
from canvit.distill.viz.plot import timestep_colors
from canvit.harness.viz.metrics import cosine_dissimilarity
from canvit.harness.viz.pca import fit_pca, pca_rgb
