...
from canvit.distill.viz import imagenet_denormalize_to_numpy, timestep_colors
from canvit.harness.optim.scheduler import warmup_constant_scheduler
from canvit.harness.rollout.viewpoint import (
    PixelBox,
