...
shard-aligned schedule as distill pretraining (``canvit.harness.infra.schedule``):
...
VAL: the IN1k validation ImageFolder under ``canvit.core.preprocess`` (resize the
